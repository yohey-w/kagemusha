...
**指標**: 「本人が自発的に言い出した介入の数」。ゼロに近いほど、分岐が問いの形で先に届いている。ある夜は10件だったが、分岐台帳を先に配送した翌日は6分岐すべてが問いの形で届き、自発介入は0だった。
...
反例で出た失敗の多くは、この定石（目的の共有・As-Is/Toの再提示・in/outスコープ・タイムボックス・網羅的な不明点確認）が既に埋める形の穴だった。
